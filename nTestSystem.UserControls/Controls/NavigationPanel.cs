...
namespace nTestSystem.UserControls.Controls
{
    public class NavigationPanel : ContentControl
    {
        ...
        private List<GroupBoxNormal> mHeaderList;
        ...
        public static readonly DependencyProperty IndicatorHorizontalAlignmentProperty =
            DependencyProperty.Register("IndicatorHorizontalAlignment", typeof(HorizontalAlignment), typeof(NavigationPanel));
        ...
        private static void IndicatorSelectedIndexCallback(DependencyObject d, DependencyPropertyChangedEventArgs e)
        {
            ...
            if (d is NavigationPanel navigationPanel && navigationPanel.mHeaderList != null && index < navigationPanel.mHeaderList.Count)
            {
        ...
        {
            mHeaderList = VisualHelper.FindVisualChildrenEx<GroupBoxNormal>(PART_ContentPresenter);
            if (mHeaderList != null)
            {
            ...
            mScrollViewer = VisualHelper.FindVisualChild<ScrollViewer>(PART_ContentPresenter);
            if (mScrollViewer != null)
            {
